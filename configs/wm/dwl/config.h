...
static const float focuscolor[]            = COLOR(0x4a4a4aff);
static const float urgentcolor[]           = COLOR(0xa04040ff);
...
/* started as: dwl -s ~/.config/ibr/autostart */
static const Key keys[] = {
	...
	{ 0,                         XKB_KEY_Print,       spawn,            SHCMD("@SHOT@") },
